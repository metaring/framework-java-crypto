...
public abstract class DecryptFunctionality extends AbstractFunctionality implements GeneratedFunctionality {

    protected DecryptFunctionality(SysKB sysKB) {
        super(sysKB, CryptoFunctionalitiesManager.DECRYPT, String.class);
    }
    ...
    protected final CompletableFuture<Object> call(Object input) throws Exception {
        CompletableFuture<String> call = call((String) input);
        if(call == null) {
            return end(null);
        }
    ...
    protected abstract CompletableFuture<String> call(String input) throws Exception;
    ...
    protected static final DecryptFunctionality create(SysKB sysKB) {
        return new DecryptFunctionalityImpl(sysKB);
    }
}